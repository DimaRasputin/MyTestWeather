...
public class Gallery implements Navigable {

    private static final Logger logger = LogManager.getLogger(Gallery.class.getSimpleName());
    ...
    public void navigate(DriverWrapper driverWrapper, Context context, Reporter reporter) {
        ...
        new Click(ByHandler.getBy(context, "novest.testNovest.userInterface.gallery"))
