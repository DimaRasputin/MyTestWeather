...
public class SolveProblem implements Navigable {

    private static final Logger logger = LogManager.getLogger(SolveProblem.class.getSimpleName());
    ...
    public void navigate(DriverWrapper driverWrapper, Context context, Reporter reporter) {
        ...
        new Click(ByHandler.getBy(context, "novest.solveTheProblem"))
                .act(driverWrapper, context, reporter);
        new WaitFor(ByHandler.getBy(context, "common.flagPageLoad"),
                Const.PAGE_COMPLETELY_LOADED_TIMEOUT).act(driverWrapper, context, reporter);
    }

    public SolveProblem fillEMailAddress(String Mail, DriverWrapper driverWrapper, Context context, Reporter reporter) {
    ...
    public SolveProblem fillPassword(String Password, DriverWrapper driverWrapper, Context context, Reporter reporter) {
    ...
    public SolveProblem clickLogin (DriverWrapper driverWrapper, Context context, Reporter reporter) {
    ...
    public SolveProblem clickForgotYourPassword (DriverWrapper driverWrapper, Context context, Reporter reporter) {
